...
:mod:`altrios.lifts.terminal.python_helpers`) instantiates the union of all
three bundles via :func:`altrios.lifts.workflow_engine.build_state_from_specs`
...
from altrios.lifts.terminal.classes import (
    chassis,
    rtg,
    sts_crane,
    top_pick,
...
from altrios.lifts.workflow_engine import ResourceSpec
