...
TERMINAL = "Allouez"
SITE_NAME = "allouez_vessel_truck"
...
def main() -> None:
    """Run the ``vessel_truck`` mode freight demo end-to-end.

    Loads the vessel-truck site YAML, runs the simulation with a
    fixed seed of ``42``, assembles container-data / resource-log
    outputs, prints the wall-clock runtime, and dumps a summary of
