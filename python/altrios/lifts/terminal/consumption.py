...
:func:`altrios.lifts.terminal.python_helpers.assemble_outputs`) so freight
...
# in :mod:`altrios.lifts.terminal.yard_flow` and :mod:`altrios.lifts.terminal.python_helpers`.
