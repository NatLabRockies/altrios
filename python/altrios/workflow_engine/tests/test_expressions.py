"""Unit tests for :mod:`altrios.workflow_engine.expressions`.
...
from altrios.workflow_engine.expressions import (
    Expression,
    ExpressionContext,
    ExpressionError,
    NamespaceProxy,
...
def test_entity_namespace_flattens_attrs():
    ...
    from altrios.workflow_engine.expressions import NamespaceProxy
