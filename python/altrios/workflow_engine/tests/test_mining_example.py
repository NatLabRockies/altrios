...
Validates that :func:`altrios.workflow_engine.run_site` runs against
...
from altrios.workflow_engine.examples import mining_helpers  # noqa: F401


EXAMPLE_SITE = Path(__file__).resolve().parents[1] / "examples" / "sites" / "example_mine.yaml"
